...
const I2C_ARRAY Sensor_init_table_4M30fps[] = {
    // Cleaned_0x01_FT_SC4336P_MIPI_27Minput_2lane_10bit_630Mbps_2560x1440_30fps_LDO_1.35v
    { 0x0103, 0x01 },
    { 0x36e9, 0x80 },
    { 0x37f9, 0x80 },
    { 0x301f, 0x01 },
...
static int SC4336_SetPatternMode(ms_cus_sensor* handle, u32 mode)
{
...
static int pCus_init_mipi2lane_linear_4M30fps(ms_cus_sensor* handle)
{
    SC4336_params* params = (SC4336_params*)handle->private_data;
    // SENSOR_DMSG("\n\n[%s]", __FUNCTION__);
    int i, cnt;
...
static int SC4336_GetShutterInfo(struct __ms_cus_sensor* handle, CUS_SHUTTER_INFO* info)
{
    info->max = 1000000000 / Preview_MIN_FPS;
    info->min = Preview_line_period * 2 + 999; // update 20220614
...
int cus_camsensor_init_handle_linear(ms_cus_sensor* drv_handle)
{
    ...
    //    sensor model ID                           //
    ////////////////////////////////////
    sprintf(handle->model_id, "SC4336_MIPI_PAD0");
    ...
    handle->pCus_sensor_GetShutterInfo = SC4336_GetShutterInfo;
    params->expo.vts = vts_30fps;
    params->expo.fps = 30;
