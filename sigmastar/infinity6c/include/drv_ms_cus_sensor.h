...
typedef struct __ms_cus_sensor {
    ...
    // spi
    app_spi_cfg spi_cfg; /**< Sensor spi setting */
    spi_handle_t* spi_bus; /**< Handle to sensor spi API. */
    ...
    // Dual sensor frame sync with pwm signal
    u32 CurTotalVertLine; /** < Current total vetrical line */
    u8 bChangeVTS;
    ////////////////////////////////////////////////
    // system functions
    ////////////////////////////////////////////////
