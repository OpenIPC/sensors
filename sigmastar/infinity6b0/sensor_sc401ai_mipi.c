...
#define SENSOR_MAXGAIN        (23320*3175)/100000         // max sensor gain, a-gain*conversion-gain*d-gain
...
static int sc401ai_SetPatternMode(ms_cus_sensor *handle,u32 mode)
{
  int i;
  SENSOR_DMSG("\n\n[%s], mode=%d \n", __FUNCTION__, mode);
...
static int sc401ai_GetShutterInfo(struct __ms_cus_sensor* handle,CUS_SHUTTER_INFO *info)
{
...
static int sc401ai_GetShutterInfo_HDR_LEF(struct __ms_cus_sensor* handle,CUS_SHUTTER_INFO *info)
{
...
static int sc401ai_GetShutterInfo_HDR_SEF(struct __ms_cus_sensor* handle,CUS_SHUTTER_INFO *info)
{
    sc401ai_params *params = (sc401ai_params *)handle->private_data;
...
int cus_camsensor_init_handle(ms_cus_sensor* drv_handle) {
   ms_cus_sensor *handle = drv_handle;
    ...
    //    sensor model ID                           //
    ////////////////////////////////////
    sprintf(handle->model_id,"sc401ai_MIPI");
    ...
    handle->pCus_sensor_GetShutterInfo = sc401ai_GetShutterInfo;
    params->expo.vts=vts_30fps;
    params->expo.fps = 30;
...
{
    ms_cus_sensor *handle = drv_handle;
    sc401ai_params *params = NULL;

    cus_camsensor_init_handle(drv_handle);
    params = (sc401ai_params *)handle->private_data;

    sprintf(handle->model_id,"sc401ai_MIPI_HDR_SEF");
    ...
    handle->pCus_sensor_GetShutterInfo = sc401ai_GetShutterInfo_HDR_SEF;
...
int cus_camsensor_init_handle_HDR_LEF(ms_cus_sensor* drv_handle) {
    ...
    //    sensor model ID                           //
    ////////////////////////////////////
    sprintf(handle->model_id,"sc401ai_MIPI_HDR_LEF");
    ...
    handle->pCus_sensor_GetShutterInfo = sc401ai_GetShutterInfo_HDR_LEF;
    handle->pCus_sensor_CustDefineFunction = pCus_sensor_CustDefineFunction;
