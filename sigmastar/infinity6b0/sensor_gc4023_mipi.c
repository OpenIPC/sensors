...
static int gc4023_SetPatternMode(ms_cus_sensor* handle, u32 mode)
{
...
static int gc4023_GetShutterInfo(struct __ms_cus_sensor* handle, CUS_SHUTTER_INFO* info)
{
...
int cus_camsensor_init_handle(ms_cus_sensor* drv_handle)
{
    ...
    //    sensor model ID                           //
    ////////////////////////////////////
    strcpy(handle->model_id, "gc4023_MIPI");
