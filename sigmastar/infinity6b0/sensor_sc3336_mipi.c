...
SENSOR_DRV_ENTRY_IMPL_BEGIN_EX(SC3336);
...
static int pCus_poweroff(ms_cus_sensor* handle, u32 idx)
{
    // power/reset low
    ISensorIfAPI* sensor_if = handle->sensor_if_api;
    sc3336_params* params = (sc3336_params*)handle->private_data;
...
static int sc3336_SetPatternMode(ms_cus_sensor* handle, u32 mode)
{
    int i;
    SENSOR_DMSG("\n\n[%s], mode=%d \n", __FUNCTION__, mode);
...
static int sc3336_GetShutterInfo(struct __ms_cus_sensor* handle, CUS_SHUTTER_INFO* info)
{
...
int cus_camsensor_init_handle(ms_cus_sensor* drv_handle)
{
    ...
    params = (sc3336_params*)handle->private_data;
    ...
    //    sensor model ID                           //
    ////////////////////////////////////
    sprintf(handle->model_id, "SC3336_MIPI");
    ...
    handle->pCus_sensor_SetPatternMode = sc3336_SetPatternMode;
    ///////////////////////////////////////////////////////
    // AE
    ///////////////////////////////////////////////////////
    // unit: micro seconds
    ...
    handle->pCus_sensor_GetShutterInfo = sc3336_GetShutterInfo;
    params->expo.vts = vts_30fps;
    params->expo.fps = 30;
...
SENSOR_DRV_ENTRY_IMPL_END_EX(SC3336,
